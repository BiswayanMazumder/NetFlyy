...
class sex_ed_04 extends StatefulWidget {
  const sex_ed_04({Key? key}) : super(key: key);

  @override
  State<sex_ed_04> createState() => _sex_ed_04State();
}

class _sex_ed_04State extends State<sex_ed_04> {
  ...
  Widget build(BuildContext context) {
    return CupertinoPageScaffold(
      ...
      navigationBar: const CupertinoNavigationBar(
        backgroundColor: CupertinoColors.black,
        middle: Text("Sex Education Season-4 Trailer",style:TextStyle(
...
String videoUrlLandscape =
    "https://cloud.appwrite.io/v1/storage/buckets/64e06014b029b4116daf/files/655232cbce3023f0b399/view?project=64e0600003aac5802fbc&mode=admin";
