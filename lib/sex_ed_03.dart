...
class sex_ed_03 extends StatefulWidget {
  const sex_ed_03({Key? key}) : super(key: key);

  @override
  State<sex_ed_03> createState() => _sex_ed_03State();
}

class _sex_ed_03State extends State<sex_ed_03> {
  ...
  Widget build(BuildContext context) {
    return CupertinoPageScaffold(
      ...
      navigationBar: const CupertinoNavigationBar(
        backgroundColor: CupertinoColors.black,
        middle: Text("Sex Education Season-3 Trailer",style:TextStyle(
...
String videoUrlLandscape =
    "https://cloud.appwrite.io/v1/storage/buckets/64e06014b029b4116daf/files/655232b6f1c22666e873/view?project=64e0600003aac5802fbc&mode=admin";
