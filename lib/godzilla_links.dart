...
class godzilla_links extends StatefulWidget {
  const godzilla_links({Key? key}) : super(key: key);

  @override
  State<godzilla_links> createState() => _godzilla_linksState();
}

class _godzilla_linksState extends State<godzilla_links> {
  ...
  Widget build(BuildContext context) {
    return CupertinoPageScaffold(
      ...
      navigationBar: const CupertinoNavigationBar(
        backgroundColor: CupertinoColors.black,
        middle: Text("GodZilla Vs Kong Trailer",style:TextStyle(
...
String videoUrlLandscape =
    'https://cloud.appwrite.io/v1/storage/buckets/64e06014b029b4116daf/files/6550f56d25b8a311cc21/view?project=64e0600003aac5802fbc&mode=admin';
