...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return const CupertinoApp(
      ...
      home: Breaking_bad_s02(),
    );
  }
}

class Breaking_bad_s02 extends StatefulWidget {
  const Breaking_bad_s02({Key? key}) : super(key: key);

  @override
  State<Breaking_bad_s02> createState() => _Breaking_bad_s02State();
}

class _Breaking_bad_s02State extends State<Breaking_bad_s02> {
  ...
  Widget build(BuildContext context) {
    return CupertinoPageScaffold(
      ...
      navigationBar: const CupertinoNavigationBar(
        backgroundColor: CupertinoColors.black,
        middle: Text("Breaking Bad Season-2 Trailer",style:TextStyle(
...
String videoUrlLandscape =
    "https://cloud.appwrite.io/v1/storage/buckets/64e06014b029b4116daf/files/6541e1866715cdd738fd/view?project=64e0600003aac5802fbc&mode=admin";
