...
class Chainsaw_links extends StatefulWidget {
  const Chainsaw_links({Key? key}) : super(key: key);

  @override
  State<Chainsaw_links> createState() => _Chainsaw_linksState();
}

class _Chainsaw_linksState extends State<Chainsaw_links> {
  ...
  Widget build(BuildContext context) {
    return CupertinoPageScaffold(
      ...
      navigationBar: const CupertinoNavigationBar(
        backgroundColor: CupertinoColors.black,
        middle: Text("Chainsaw Man Trailer",style:TextStyle(
...
String videoUrlLandscape =
    "https://cloud.appwrite.io/v1/storage/buckets/64e06014b029b4116daf/files/653e87e2798651bdeaaa/view?project=64e0600003aac5802fbc&mode=admin";
