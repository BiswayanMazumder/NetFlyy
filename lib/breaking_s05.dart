...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return const CupertinoApp(
      ...
      home: Breaking_bad_s05(),
    );
  }
}

class Breaking_bad_s05 extends StatefulWidget {
  const Breaking_bad_s05({Key? key}) : super(key: key);

  @override
  State<Breaking_bad_s05> createState() => _Breaking_bad_s05State();
}

class _Breaking_bad_s05State extends State<Breaking_bad_s05> {
  ...
  Widget build(BuildContext context) {
    return CupertinoPageScaffold(
      ...
      navigationBar: const CupertinoNavigationBar(
        backgroundColor: CupertinoColors.black,
        middle: Text("Breaking Bad Season-5 Trailer",style:TextStyle(
