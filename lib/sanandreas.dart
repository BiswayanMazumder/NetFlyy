...
class Sanandreas extends StatefulWidget {
  const Sanandreas({Key? key}) : super(key: key);

  @override
  State<Sanandreas> createState() => _SanandreasState();
}

class _SanandreasState extends State<Sanandreas> {
  ...
  void _checkIfStarred() async {
    ...
    if (user != null) {
      ...
      final movieRef = _firestore.collection('starred').doc(userId).collection('starredMovies').doc('Saandreas');
  ...
  Future<void> _toggleStar() async {
    ...
    if (user != null) {
      final userId = user.uid;
      final starredMoviesRef = _firestore.collection('starred').doc(userId).collection('starredMovies').doc('Saandreas');
  ...
  void saveRatingToFirestore(bool isLiked) {
    _firestore.collection('ratings_sa').add({
      'isLiked': isLiked,
      'timestamp': FieldValue.serverTimestamp(),
    });
  }
            ...
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  image: DecorationImage(image: NetworkImage('https://cloud.appwrite.io/v1/storage/buckets/64e06014b029b4116daf/files/6528d0c423ec163c3772/view?project=64e0600003aac5802fbc&mode=admin'),fit: BoxFit.fitHeight,
                      opacity: 60.000),
              ...
              Positioned(child: SizedBox(
                width: 250.0,
                height: 800.0,
                child: Image.network('https://cloud.appwrite.io/v1/storage/buckets/64e06014b029b4116daf/files/6528d1827e9ce414dd18/view?project=64e0600003aac5802fbc&mode=admin',
                  width: 120,
                  height: 500,
                ),
              )),
                ...
                child: ElevatedButton(
                    onPressed: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => const Sanandreas_links()),
                      );
                    },
                    style: ButtonStyle(
                        backgroundColor:
            ...
            children: [
              ...
              Align(
                  ...
                  child: StreamBuilder<QuerySnapshot>(
                      stream: _firestore.collection('ratings_sa').snapshots(),
