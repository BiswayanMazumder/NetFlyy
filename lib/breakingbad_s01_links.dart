...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return const CupertinoApp(
      ...
      home: Breaking_bad_s01(),
    );
  }
}

class Breaking_bad_s01 extends StatefulWidget {
  const Breaking_bad_s01({Key? key}) : super(key: key);

  @override
  State<Breaking_bad_s01> createState() => _Breaking_bad_s01State();
}

class _Breaking_bad_s01State extends State<Breaking_bad_s01> {
  ...
  Widget build(BuildContext context) {
    return CupertinoPageScaffold(
      ...
      navigationBar: const CupertinoNavigationBar(
        backgroundColor: CupertinoColors.black,
        middle: Text("Breaking Bad Season-1 Trailer",style:TextStyle(
...
String videoUrlLandscape =
    "https://cloud.appwrite.io/v1/storage/buckets/64e06014b029b4116daf/files/6541cf3dd8966b9b6d44/view?project=64e0600003aac5802fbc&mode=admin";
