...
import 'package:netflix/twoandahalf_link.dart';
import 'package:razorpay_flutter/razorpay_flutter.dart';
import 'package:cloud_firestore/cloud_firestore.dart';
import 'package:firebase_auth/firebase_auth.dart';
class twoandahalf extends StatefulWidget {
  const twoandahalf({Key? key}) : super(key: key);

  @override
  State<twoandahalf> createState() => _twoandahalfState();
}

class _twoandahalfState extends State<twoandahalf> {
  ...
  void _checkIfStarred() async {
    ...
    if (user != null) {
      ...
      final movieRef = _firestore.collection('starred').doc(userId).collection('starredMovies').doc('Two_Men');
  ...
  Future<void> _toggleStar() async {
    ...
    if (user != null) {
      final userId = user.uid;
      final starredMoviesRef = _firestore.collection('starred').doc(userId).collection('starredMovies').doc('Two_Men');
            ...
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  image: DecorationImage(image: NetworkImage('https://cloud.appwrite.io/v1/storage/buckets/64e06014b029b4116daf/files/65360b3de1229fe0579b/view?project=64e0600003aac5802fbc&mode=admin'),fit: BoxFit.fitHeight,
                      opacity: 60.000),
              ...
              Positioned(child: SizedBox(
                width: 180.0,
                height: 800.0,
                child: Image.network('https://cloud.appwrite.io/v1/storage/buckets/64e06014b029b4116daf/files/65360de5613a4bb4981d/view?project=64e0600003aac5802fbc&mode=admin'),
              )),
            ],
          ),
          Column(
                ...
                ElevatedButton(
                  onPressed: (){
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => const two_links()));
    },
