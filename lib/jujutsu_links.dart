...
class jujutsu_links extends StatefulWidget {
  const jujutsu_links({Key? key}) : super(key: key);

  @override
  State<jujutsu_links> createState() => _jujutsu_linksState();
}

class _jujutsu_linksState extends State<jujutsu_links> {
  ...
  Widget build(BuildContext context) {
    return CupertinoPageScaffold(
      ...
      navigationBar: const CupertinoNavigationBar(
        backgroundColor: CupertinoColors.black,
        middle: Text("Jujutsu Kaisen Trailer",style:TextStyle(
...
String videoUrlLandscape =
    "https://cloud.appwrite.io/v1/storage/buckets/64e06014b029b4116daf/files/jujutsu_kaisen/view?project=64e0600003aac5802fbc&mode=admin";
