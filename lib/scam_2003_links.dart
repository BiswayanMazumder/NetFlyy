...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return const CupertinoApp(
      ...
      home: Scam_2003_trailer(),
    );
  }
}

class Scam_2003_trailer extends StatefulWidget {
  const Scam_2003_trailer({Key? key}) : super(key: key);

  @override
  State<Scam_2003_trailer> createState() => _Scam_2003_trailerState();
}

class _Scam_2003_trailerState extends State<Scam_2003_trailer> {
  ...
  Widget build(BuildContext context) {
    return CupertinoPageScaffold(
      ...
      navigationBar: const CupertinoNavigationBar(
        backgroundColor: CupertinoColors.black,
        middle: Text("Scam 2003 Trailer",style:TextStyle(
...
String videoUrlLandscape =
    "https://cloud.appwrite.io/v1/storage/buckets/64e06014b029b4116daf/files/655ad87c9ed27d1ba91c/view?project=64e0600003aac5802fbc&mode=admin";
