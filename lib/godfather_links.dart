...
class God01 extends StatefulWidget {
  const God01({Key? key}) : super(key: key);

  @override
  State<God01> createState() => _God01State();
}

class _God01State extends State<God01> {
  ...
  Widget build(BuildContext context) {
    return CupertinoPageScaffold(
      ...
      navigationBar: const CupertinoNavigationBar(
        backgroundColor: CupertinoColors.black,
        middle: Text("GodFather",style:TextStyle(
...
String videoUrlLandscape =
    "https://cloud.appwrite.io/v1/storage/buckets/64e06014b029b4116daf/files/64e07ee49ee6923ded0d/view?project=64e0600003aac5802fbc&mode=admin";
