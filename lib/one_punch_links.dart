...
class Onepunchlinks extends StatefulWidget {
  const Onepunchlinks({Key? key}) : super(key: key);

  @override
  State<Onepunchlinks> createState() => _OnepunchlinksState();
}

class _OnepunchlinksState extends State<Onepunchlinks> {
  ...
  Widget build(BuildContext context) {
    return CupertinoPageScaffold(
      ...
      navigationBar: const CupertinoNavigationBar(
        backgroundColor: CupertinoColors.black,
        middle: Text("One Punch Man Trailer",style:TextStyle(
...
String videoUrlLandscape =
    "https://cloud.appwrite.io/v1/storage/buckets/64e06014b029b4116daf/files/654136f1dee7728e5b8c/view?project=64e0600003aac5802fbc&mode=admin";
