...
class Stranger01 extends StatefulWidget {
  const Stranger01({Key? key}) : super(key: key);

  @override
  State<Stranger01> createState() => _Stranger01State();
}

class _Stranger01State extends State<Stranger01> {
  ...
  Widget build(BuildContext context) {
    return CupertinoPageScaffold(
      ...
      navigationBar: const CupertinoNavigationBar(
        backgroundColor: CupertinoColors.black,
        middle: Text("Stranger Things Season-1",style:TextStyle(
...
String videoUrlLandscape =
    "https://cloud.appwrite.io/v1/storage/buckets/64e06014b029b4116daf/files/Stranger_Things_season_01/view?project=64e0600003aac5802fbc&mode=admin";
