...
class TV_weekly extends StatefulWidget {
  const TV_weekly({Key? key}) : super(key: key);

  @override
  State<TV_weekly> createState() => _TV_weeklyState();
}

class _TV_weeklyState extends State<TV_weekly> {
  ...
  Future<List<Map<String, dynamic>>> fetchTrendingTVdaily() async {
