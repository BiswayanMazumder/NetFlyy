...
class sex_ed_02 extends StatefulWidget {
  const sex_ed_02({Key? key}) : super(key: key);

  @override
  State<sex_ed_02> createState() => _sex_ed_02State();
}

class _sex_ed_02State extends State<sex_ed_02> {
  ...
  Widget build(BuildContext context) {
    return CupertinoPageScaffold(
      ...
      navigationBar: const CupertinoNavigationBar(
        backgroundColor: CupertinoColors.black,
        middle: Text("Sex Education Season-2 Trailer",style:TextStyle(
...
String videoUrlLandscape =
    "https://cloud.appwrite.io/v1/storage/buckets/64e06014b029b4116daf/files/655232a7271c8b10a803/view?project=64e0600003aac5802fbc&mode=admin";
