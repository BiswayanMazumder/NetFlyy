...
class majnu extends StatefulWidget {
  const majnu({Key? key}) : super(key: key);

  @override
  State<majnu> createState() => _majnuState();
}

class _majnuState extends State<majnu> {
  ...
  Widget build(BuildContext context) {
    return CupertinoPageScaffold(
      ...
      navigationBar: const CupertinoNavigationBar(
        backgroundColor: CupertinoColors.black,
        middle: Text("Mission Majnu",style:TextStyle(
...
String videoUrlLandscape =
    "https://cloud.appwrite.io/v1/storage/buckets/64e06014b029b4116daf/files/6566e8621d0961532a7c/view?project=64e0600003aac5802fbc&mode=admin";
