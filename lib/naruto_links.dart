...
class naruto_links extends StatefulWidget {
  const naruto_links({Key? key}) : super(key: key);

  @override
  State<naruto_links> createState() => _naruto_linksState();
}

class _naruto_linksState extends State<naruto_links> {
  ...
  Widget build(BuildContext context) {
    return CupertinoPageScaffold(
      ...
      navigationBar: const CupertinoNavigationBar(
        backgroundColor: CupertinoColors.black,
        middle: Text("Naruto Shippuden Trailer",style:TextStyle(
...
String videoUrlLandscape =
    "https://cloud.appwrite.io/v1/storage/buckets/64e06014b029b4116daf/files/naruto/view?project=64e0600003aac5802fbc&mode=admin";
