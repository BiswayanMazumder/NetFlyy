...
class sex_ed_01 extends StatefulWidget {
  const sex_ed_01({Key? key}) : super(key: key);

  @override
  State<sex_ed_01> createState() => _sex_ed_01State();
}

class _sex_ed_01State extends State<sex_ed_01> {
  ...
  Widget build(BuildContext context) {
    return CupertinoPageScaffold(
      ...
      navigationBar: const CupertinoNavigationBar(
        backgroundColor: CupertinoColors.black,
        middle: Text("Sex Education Season-1 Trailer",style:TextStyle(
...
String videoUrlLandscape =
    "https://cloud.appwrite.io/v1/storage/buckets/64e06014b029b4116daf/files/65523263efe0aa60528e/view?project=64e0600003aac5802fbc&mode=admin";
