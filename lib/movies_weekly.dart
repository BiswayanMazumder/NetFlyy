...
class MoviesWeekly extends StatefulWidget {
  const MoviesWeekly({Key? key}) : super(key: key);

  @override
  State<MoviesWeekly> createState() => _MoviesWeeklyState();
}

class _MoviesWeeklyState extends State<MoviesWeekly> {
      ...
      body: Container(
        child: SingleChildScrollView(
          child: Column(
            children: [
              FutureBuilder(
                future: fetchTrendingMoviesmonth(),
