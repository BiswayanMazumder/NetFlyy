...
class Stranger02 extends StatefulWidget {
  const Stranger02({Key? key}) : super(key: key);

  @override
  State<Stranger02> createState() => _Stranger02State();
}

class _Stranger02State extends State<Stranger02> {
  ...
  Widget build(BuildContext context) {
    return CupertinoPageScaffold(
      ...
      navigationBar: const CupertinoNavigationBar(
        backgroundColor: CupertinoColors.black,
        middle: Text("Stranger Things Season-2",style:TextStyle(
...
String videoUrlLandscape =
    "https://cloud.appwrite.io/v1/storage/buckets/64e06014b029b4116daf/files/64e0796c5d92535a6cfe/view?project=64e0600003aac5802fbc&mode=admin";
