...
class Peaky03 extends StatefulWidget {
  const Peaky03({Key? key}) : super(key: key);

  @override
  State<Peaky03> createState() => _Peaky03State();
}

class _Peaky03State extends State<Peaky03> {
  @override
          ...
          Container(
            ...
            child: ElevatedButton(
                onPressed: () {
                  ...
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => const Peakys1ep3()),
                  );
                },
                style: ButtonStyle(
          ...
          Container(
            ...
            child: Column(
              children: [
                ...
                Padding(padding: EdgeInsets.all(10)),
                Text(
                  '"Peaky Blinders" Season 3 is a British historical crime drama series set in post-World War'
