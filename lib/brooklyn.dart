...
class Brooklyn extends StatefulWidget {
  const Brooklyn({Key? key}) : super(key: key);

  @override
  State<Brooklyn> createState() => _BrooklynState();
}

class _BrooklynState extends State<Brooklyn> {
  ...
  Widget build(BuildContext context) {
    return CupertinoPageScaffold(
      ...
      navigationBar: const CupertinoNavigationBar(
        backgroundColor: CupertinoColors.black,
        middle: Text("Brooklyn Nine Nine Trailer",style:TextStyle(
...
String videoUrlLandscape =
    "https://cloud.appwrite.io/v1/storage/buckets/64e06014b029b4116daf/files/653ab29996fe9f5c1e50/view?project=64e0600003aac5802fbc&mode=admin";
