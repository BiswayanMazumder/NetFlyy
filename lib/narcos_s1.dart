...
class Narcos_s1 extends StatefulWidget {
  const Narcos_s1({Key? key}) : super(key: key);

  @override
  State<Narcos_s1> createState() => _Narcos_s1State();
}

class _Narcos_s1State extends State<Narcos_s1> {
  ...
  Widget build(BuildContext context) {
    return CupertinoPageScaffold(
      ...
      navigationBar: const CupertinoNavigationBar(
        backgroundColor: CupertinoColors.black,
        middle: Text("Narcos Season 1",style:TextStyle(
...
String videoUrlLandscape =
    "https://cloud.appwrite.io/v1/storage/buckets/64e06014b029b4116daf/files/6543b0762a50d9d8b199/view?project=64e0600003aac5802fbc&mode=admin";
