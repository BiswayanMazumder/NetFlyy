...
class Cherry01 extends StatefulWidget {
  const Cherry01({Key? key}) : super(key: key);

  @override
  State<Cherry01> createState() => _Cherry01State();
}

class _Cherry01State extends State<Cherry01> {
  ...
  Widget build(BuildContext context) {
    return CupertinoPageScaffold(
      ...
      navigationBar: const CupertinoNavigationBar(
        backgroundColor: CupertinoColors.black,
        middle: Text(
          "Brand New Cherry Flavour Trailer",
...
String videoUrlLandscape =
    "https://cloud.appwrite.io/v1/storage/buckets/64e06014b029b4116daf/files/64e1e2691c884e5f6778/view?project=64e0600003aac5802fbc&mode=admin";
