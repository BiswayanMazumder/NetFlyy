...
class otto_links extends StatefulWidget {
  const otto_links({Key? key}) : super(key: key);

  @override
  State<otto_links> createState() => _otto_linksState();
}

class _otto_linksState extends State<otto_links> {
  ...
  Widget build(BuildContext context) {
    return CupertinoPageScaffold(
      ...
      navigationBar: const CupertinoNavigationBar(
        backgroundColor: CupertinoColors.black,
        middle: Text("A Man Called OTTO Trailer",style:TextStyle(
...
String videoUrlLandscape =
    'https://cloud.appwrite.io/v1/storage/buckets/64e06014b029b4116daf/files/654fb00d6cf4a900373b/view?project=64e0600003aac5802fbc&mode=admin';
