...
class Raees01 extends StatefulWidget {
  const Raees01({Key? key}) : super(key: key);

  @override
  State<Raees01> createState() => _Raees01State();
}

class _Raees01State extends State<Raees01> {
  ...
  Widget build(BuildContext context) {
    return CupertinoPageScaffold(
      ...
      navigationBar: const CupertinoNavigationBar(
        backgroundColor: CupertinoColors.black,
        middle: Text("Raees",style:TextStyle(
...
String videoUrlLandscape =
    "https://cloud.appwrite.io/v1/storage/buckets/64e06014b029b4116daf/files/6568858bde0977cd466f/view?project=64e0600003aac5802fbc&mode=admin";
