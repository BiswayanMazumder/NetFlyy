...
class Stranger03 extends StatefulWidget {
  const Stranger03({Key? key}) : super(key: key);

  @override
  State<Stranger03> createState() => _Stranger03State();
}

class _Stranger03State extends State<Stranger03> {
  ...
  Widget build(BuildContext context) {
    return CupertinoPageScaffold(
      ...
      navigationBar: const CupertinoNavigationBar(
        backgroundColor: CupertinoColors.black,
        middle: Text("Stranger Things Season-3",style:TextStyle(
...
String videoUrlLandscape =
    "https://cloud.appwrite.io/v1/storage/buckets/64e06014b029b4116daf/files/64e07b3b4cf12f125ca4/view?project=64e0600003aac5802fbc&mode=admin";
