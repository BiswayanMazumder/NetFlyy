...
class Peaky02 extends StatefulWidget {
  const Peaky02({Key? key}) : super(key: key);

  @override
  State<Peaky02> createState() => _Peaky02State();
}

class _Peaky02State extends State<Peaky02> {
  @override
    ...
    return Scaffold(
      ...
      body: ListView(
        children: [
          Image(
              image: NetworkImage(
                  'https://firebasestorage.googleapis.com/v0/b/netflix-5002f.appspot.com/o/Peaky%20Blinders%20_%20Season%205%20Trailer%20_%20Netflix.gif?alt=media&token=046a5989-0920-40f6-b5f3-c14d0daddf24')),
          SizedBox(
            height: 30,
          ),
          Row(
          ...
          Container(
            ...
            child: ElevatedButton(
                onPressed: () {
                  ...
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => const Peakys01ep02()),
                  );
                },
                style: ButtonStyle(
          ...
          Container(
            ...
            child: Column(
              children: [
                ...
                Padding(padding: EdgeInsets.all(10)),
                Text(
                  '"Peaky Blinders" Season 2 is a British historical crime drama series set in post-World War'
