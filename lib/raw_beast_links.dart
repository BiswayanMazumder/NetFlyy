...
class Raw01 extends StatefulWidget {
  const Raw01({Key? key}) : super(key: key);

  @override
  State<Raw01> createState() => _Raw01State();
}

class _Raw01State extends State<Raw01> {
  ...
  Widget build(BuildContext context) {
    return CupertinoPageScaffold(
      ...
      navigationBar: const CupertinoNavigationBar(
        backgroundColor: CupertinoColors.black,
        middle: Text("Raw(Beast)",style:TextStyle(
...
String videoUrlLandscape =
    "https://cloud.appwrite.io/v1/storage/buckets/64e06014b029b4116daf/files/65688903803daaa32b6c/view?project=64e0600003aac5802fbc&mode=admin";
