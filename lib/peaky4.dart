...
class Peaky4 extends StatefulWidget {
  const Peaky4({Key? key}) : super(key: key);

  @override
  State<Peaky4> createState() => _Peaky4State();
}

class _Peaky4State extends State<Peaky4> {
  @override
          ...
          Container(
            ...
            child: ElevatedButton(
                onPressed: () {
                  ...
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => const Peakys01ep04()),
                  );
                },
                style: ButtonStyle(
          ...
          Container(
            ...
            child: Column(
              children: [
                ...
                Padding(padding: EdgeInsets.all(10)),
                Text(
                  '"Peaky Blinders" Season 4 is a British historical crime drama series set in post-World War'
