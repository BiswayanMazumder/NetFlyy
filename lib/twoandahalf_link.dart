...
class two_links extends StatefulWidget {
  const two_links({Key? key}) : super(key: key);

  @override
  State<two_links> createState() => _two_linksState();
}

class _two_linksState extends State<two_links> {
  ...
  Widget build(BuildContext context) {
    return CupertinoPageScaffold(
      ...
      navigationBar: const CupertinoNavigationBar(
        backgroundColor: CupertinoColors.black,
        middle: Text("Two And A Half Men",style:TextStyle(
...
String videoUrlLandscape =
    "https://cloud.appwrite.io/v1/storage/buckets/64e06014b029b4116daf/files/65360e6fc6873387d94a/view?project=64e0600003aac5802fbc&mode=admin";
