...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return const CupertinoApp(
      ...
      home: Breaking_bad_s04(),
    );
  }
}

class Breaking_bad_s04 extends StatefulWidget {
  const Breaking_bad_s04({Key? key}) : super(key: key);

  @override
  State<Breaking_bad_s04> createState() => _Breaking_bad_s04State();
}

class _Breaking_bad_s04State extends State<Breaking_bad_s04> {
  ...
  Widget build(BuildContext context) {
    return CupertinoPageScaffold(
      ...
      navigationBar: const CupertinoNavigationBar(
        backgroundColor: CupertinoColors.black,
        middle: Text("Breaking Bad Season-4 Trailer",style:TextStyle(
...
String videoUrlLandscape =
    'https://cloud.appwrite.io/v1/storage/buckets/64e06014b029b4116daf/files/6541eb3c605da2ac726c/view?project=64e0600003aac5802fbc&mode=admin';
