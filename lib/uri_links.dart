...
class Uri01 extends StatefulWidget {
  const Uri01({Key? key}) : super(key: key);

  @override
  State<Uri01> createState() => _Uri01State();
}

class _Uri01State extends State<Uri01> {
  ...
  Widget build(BuildContext context) {
    return CupertinoPageScaffold(
      ...
      navigationBar: const CupertinoNavigationBar(
        backgroundColor: CupertinoColors.black,
        middle: Text("Uri",style:TextStyle(
...
String videoUrlLandscape =
    "https://cloud.appwrite.io/v1/storage/buckets/64e06014b029b4116daf/files/6556e0fd644e9945cf32/view?project=64e0600003aac5802fbc&mode=admin";
