...
class Blinder extends StatefulWidget {
  const Blinder({Key? key}) : super(key: key);

  @override
  State<Blinder> createState() => _BlinderState();
}

class _BlinderState extends State<Blinder> {
  ...
  Widget build(BuildContext context) {
    return CupertinoPageScaffold(
      ...
      navigationBar: const CupertinoNavigationBar(
        backgroundColor: CupertinoColors.black,
        middle: Text("Season 1 Episode 1",style:TextStyle(
...
"https://cloud.appwrite.io/v1/storage/buckets/64e06014b029b4116daf/files/655ca276798f625f8a42/view?project=64e0600003aac5802fbc&mode=admin";
