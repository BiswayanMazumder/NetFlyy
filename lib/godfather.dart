...
import 'package:netflix/godfather_links.dart';
...
class _GodfatherState extends State<Godfather> {
  ...
  void saveRatingToFirestore(bool isLiked) {
    _firestore.collection('ratings_godfather(hindi)').add({
      'isLiked': isLiked,
  ...
  void _checkIfStarred() async {
    ...
    if (user != null) {
      ...
      final movieRef = _firestore.collection('starred').doc(userId).collection('starredMovies').doc('Godfather(hindi)');
  ...
  Future<void> _toggleStar() async {
    ...
    if (user != null) {
      final userId = user.uid;
      final starredMoviesRef = _firestore.collection('starred').doc(userId).collection('starredMovies').doc('Godfather(hindi)');
            ...
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  image: DecorationImage(image: NetworkImage('https://cloud.appwrite.io/v1/storage/buckets/64e06014b029b4116daf/files/653a87a00218fda62dfb/view?project=64e0600003aac5802fbc&mode=admin'),fit: BoxFit.fitHeight,
                      opacity: 60.000),
            ...
            children: [
              ...
              Row(
                children: [
                  ...
                  Text('2:16 mins',style: TextStyle(fontSize:15,
                      wordSpacing: 2,
                      letterSpacing: 2,
                      color: Colors.grey,
                      fontWeight: FontWeight.w700),),
            ...
            children: [
              ...
              Align(
                  ...
                  child: StreamBuilder<QuerySnapshot>(
                      stream: _firestore.collection('ratings_godfather(hindi)').snapshots(),
