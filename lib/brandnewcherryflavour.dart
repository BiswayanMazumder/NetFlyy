...
class _cherryState extends State<cherry> {
  ...
  void saveRatingToFirestore(bool isLiked) {
    _firestore.collection('ratings_cherry').add({
      'isLiked': isLiked,
  ...
  Future<void> _toggleStar() async {
    ...
    if (user != null) {
      final userId = user.uid;
      final starredMoviesRef = _firestore.collection('starred').doc(userId).collection('starredMovies').doc('Brand New Cherry Flavour');
            ...
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  image: DecorationImage(image: NetworkImage('https://cloud.appwrite.io/v1/storage/buckets/64e06014b029b4116daf/files/653a8d25e77a13776b51/view?project=64e0600003aac5802fbc&mode=admin'),fit: BoxFit.fitHeight,
                      opacity: 60.000),
              ...
              Positioned(child: SizedBox(
                width: 250.0,
                height: 800.0,
                child: Image.asset('assets/images/brand-new-cherry-flavor-movie-title.gif'),
              )),
            ],
          ),
          Column(
                ...
                child: ElevatedButton(
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => const Cherry01()),
                    );
                  },
                  style: ButtonStyle(
              ...
              Container(
                ...
                child: Column(
                  children: [
                    ...
                    Padding(padding: EdgeInsets.all(10)),
                    Text(
                      'A filmmaker heads to Hollywood in the early '
            ...
            children: [
              ...
              Align(
                  ...
                  child: StreamBuilder<QuerySnapshot>(
                      stream: _firestore.collection('ratings_cherry').snapshots(),
